...
// NOTE: OWColor now lives in Theme.swift (shared with TranscriptionOverlay). The full
// 22-member palette was merged there during the 2026-07-19 branded-popover restore.
